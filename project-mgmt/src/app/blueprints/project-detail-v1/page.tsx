              ...
              <div className="grid gap-3 lg:grid-cols-2">
                ...
                <div className="rounded-[24px] bg-[linear-gradient(180deg,rgba(10,16,26,0.76),rgba(12,18,27,0.66))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.025)]">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    {designFormFields.map(([label, placeholder]) => (
                      <label key={label} className="flex flex-col gap-2">
                        ...
                        <div className="h-11 rounded-2xl bg-white/[0.04] px-4 text-sm text-slate-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] flex items-center">
                          {placeholder}
                        </div>
                      </label>
                    ))}
                    ...
                    <label className="flex flex-col gap-2 md:col-span-2">
                      ...
                      <div className="min-h-28 rounded-2xl bg-white/[0.04] px-4 py-3 text-sm leading-7 text-slate-400 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                        請描述此設計項目的尺寸、材質與現場需求
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <button className="inline-flex items-center justify-center rounded-2xl bg-[linear-gradient(180deg,rgba(87,145,255,0.32),rgba(39,79,170,0.22))] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_18px_38px_-24px_rgba(59,130,246,0.64),inset_0_1px_0_rgba(255,255,255,0.1)]">
                      儲存設計交辦
                    </button>
                    <button className="inline-flex items-center justify-center rounded-2xl bg-white/[0.04] px-4 py-2.5 text-sm font-semibold text-slate-200">
                      取消
                    </button>
                  </div>
                </div>
