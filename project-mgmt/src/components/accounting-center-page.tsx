                    ...
                    <div className="space-y-4">
                      ...
                      {editingEmployee && editingFullTimeDraft ? (
                        <EditableBlock title={personnelViewMode === "edit" ? "正職編輯頁" : "正職預覽頁"} badge={personnelViewMode === "edit" ? "完整人事成本結構" : "預覽模式"} mode={personnelViewMode}>
                          ...
                          <DetailGroup title="加班計算區">{personnelViewMode === "edit" ? <div className="grid gap-4 xl:grid-cols-3">{editingFullTimeDraft.overtime.map((row, index) => <EditableNumberPair key={row.label} label={`${row.label} 時數`} value={row.hours} onChange={(value) => setFullTimeDrafts((current) => { const nextOvertime = [...editingFullTimeDraft.overtime]; nextOvertime[index] = { ...row, hours: value }; return { ...current, [editingEmployee.id]: { ...editingFullTimeDraft, overtime: nextOvertime } }; })} />)}</div> : editingFullTimeDraft.overtime.map((row) => <SummaryLine key={row.label} label={`${row.label}｜${row.hours} 小時 × ${row.multiplier}`} value={formatCurrency(row.amount)} />)}<SummaryLine label="加班費合計" value={formatCurrency(calculateOvertimeTotal(editingFullTimeDraft))} /></DetailGroup>
                          <DetailGroup title="應扣項目區">{personnelViewMode === "edit" ? <div className="grid gap-4 xl:grid-cols-2"><EditableNumberPair label="勞保費" value={editingFullTimeDraft.deductions.laborInsurance} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, deductions: { ...editingFullTimeDraft.deductions, laborInsurance: value } } }))} /><EditableNumberPair label="健保費" value={editingFullTimeDraft.deductions.healthInsurance} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, deductions: { ...editingFullTimeDraft.deductions, healthInsurance: value } } }))} /><EditableNumberPair label="眷屬負擔" value={editingFullTimeDraft.deductions.dependents} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, deductions: { ...editingFullTimeDraft.deductions, dependents: value } } }))} /><EditableNumberPair label="請假扣款" value={editingFullTimeDraft.deductions.leaveDeduction} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, deductions: { ...editingFullTimeDraft.deductions, leaveDeduction: value } } }))} /><EditableNumberPair label="其他扣項" value={editingFullTimeDraft.deductions.other[0]?.amount ?? 0} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, deductions: { ...editingFullTimeDraft.deductions, other: [{ label: editingFullTimeDraft.deductions.other[0]?.label ?? "其他扣項", amount: value }] } } }))} /></div> : <><SummaryLine label="勞保費" value={formatCurrency(editingFullTimeDraft.deductions.laborInsurance)} /><SummaryLine label="健保費" value={formatCurrency(editingFullTimeDraft.deductions.healthInsurance)} /><SummaryLine label="眷屬負擔" value={formatCurrency(editingFullTimeDraft.deductions.dependents)} /><SummaryLine label="請假扣款" value={formatCurrency(editingFullTimeDraft.deductions.leaveDeduction)} /><InlineAmountList title="其他扣項明細" items={editingFullTimeDraft.deductions.other} /></>}<SummaryLine label="應扣合計" value={formatCurrency(calculateFullTimeDeduction(editingFullTimeDraft))} /><SummaryLine label="實領金額" value={formatCurrency(calculateFullTimeNetPay(editingFullTimeDraft))} emphasize /></DetailGroup>
                          <DetailGroup title="單位負擔區">{personnelViewMode === "edit" ? <div className="grid gap-4 xl:grid-cols-2"><EditableNumberPair label="單位負擔勞保" value={editingFullTimeDraft.employerContribution.laborInsurance} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, employerContribution: { ...editingFullTimeDraft.employerContribution, laborInsurance: value } } }))} /><EditableNumberPair label="單位負擔健保" value={editingFullTimeDraft.employerContribution.healthInsurance} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, employerContribution: { ...editingFullTimeDraft.employerContribution, healthInsurance: value } } }))} /><EditableNumberPair label="職保" value={editingFullTimeDraft.employerContribution.occupationalInsurance} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, employerContribution: { ...editingFullTimeDraft.employerContribution, occupationalInsurance: value } } }))} /><EditableNumberPair label="勞退" value={editingFullTimeDraft.employerContribution.pension} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, employerContribution: { ...editingFullTimeDraft.employerContribution, pension: value } } }))} /><EditableNumberPair label="其他單位負擔" value={editingFullTimeDraft.employerContribution.other[0]?.amount ?? 0} onChange={(value) => setFullTimeDrafts((current) => ({ ...current, [editingEmployee.id]: { ...editingFullTimeDraft, employerContribution: { ...editingFullTimeDraft.employerContribution, other: [{ label: editingFullTimeDraft.employerContribution.other[0]?.label ?? "其他單位負擔", amount: value }] } } }))} /></div> : <><SummaryLine label="單位負擔勞保" value={formatCurrency(editingFullTimeDraft.employerContribution.laborInsurance)} /><SummaryLine label="單位負擔健保" value={formatCurrency(editingFullTimeDraft.employerContribution.healthInsurance)} /><SummaryLine label="職保" value={formatCurrency(editingFullTimeDraft.employerContribution.occupationalInsurance)} /><SummaryLine label="勞退" value={formatCurrency(editingFullTimeDraft.employerContribution.pension)} /><InlineAmountList title="其他單位負擔明細" items={editingFullTimeDraft.employerContribution.other} /></>}<SummaryLine label="單位負擔合計" value={formatCurrency(calculateFullTimeEmployerContribution(editingFullTimeDraft))} /><SummaryLine label="人事成本總支出" value={formatCurrency(calculateFullTimeCost(editingFullTimeDraft))} emphasize /></DetailGroup>
