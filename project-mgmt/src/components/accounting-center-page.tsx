          ...
          {workspaceTab === "active-projects" ? (
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="flex flex-wrap gap-2 border-b border-slate-200 pb-4">
                ...
                <button type="button" onClick={() => setExpenseTab("editor")} className={`rounded-2xl px-4 py-2.5 text-sm font-semibold ring-1 transition ${expenseTab === "editor" ? "bg-slate-900 text-white ring-slate-900" : "bg-white text-slate-600 ring-slate-200 hover:bg-slate-50"}`}>管銷編輯</button>
              </div>
              ...
              {expenseTab === "editor" ? (
                <div className="space-y-6">
                  ...
                  {expenseEditorTab === "personnel" ? (
                    ...
                    <Panel title="人事費用管理" actions={<button type="button" onClick={() => setShowAddEmployeeModal(true)} className="inline-flex items-center justify-center rounded-2xl border border-slate-900 bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800">新增員工</button>}>
