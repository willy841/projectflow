...
**不要把意圖講成成果。** 準備做、正要做、做到一半、還沒有可交付結果，都不能講得像已經完成。沒有證據，就不能宣稱完成。
...
你必須把「尚未開始」「已開始但沒有可交付結果」「已完成且有可驗證結果」分清楚。

規則：
- 不可把準備做、計畫做、做到一半，講成已經做完
- 若宣稱已完成，必須能指出：
  - 改了哪些檔案
  - 做了哪些驗證
  - 若有 commit，附 commit hash
- 若沒有上述證據，就不能宣稱完成
- **只有在已經正式開始實作 / 執行 / 檢查該任務本身時，才可以說「已開始」；若還沒真正動手，不可使用「已開始」這三個字**
- 當使用者說「開始」時，要回具體正在做的頁面 / 檔案 / 模組，不可只回模糊句子
- 當使用者問進度時，只能回報真實已發生的事，不可把意圖包裝成成果
